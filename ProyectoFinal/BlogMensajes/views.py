...
class ConversacionListView(LoginRequiredMixin, ListView):
    ...
    template_name = 'BlogMensajes/conversacion_list.html'
...
class ConversacionCreateView(LoginRequiredMixin, CreateView):
    ...
    template_name = 'BlogMensajes/conversacion_crear.html'
...
class ConversacionDetailView(LoginRequiredMixin, DetailView):
    ...
    template_name = 'BlogMensajes/conversacion_detalle.html'
...
class AgregarMensajeConversacionView(LoginRequiredMixin, View):
    def post(self, request, **kwargs):
        ...
        nuevo_mensaje.save()
        return redirect(reverse_lazy('VerConversacion', kwargs={'room_id': conversacion_id}))